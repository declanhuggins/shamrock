...
- **Cadre & Leadership**: table columns role, rank, last/first, email, office phone, cell, office; minimal contact view.
...
- **Attendance**: cadet list synced from Directory (last/first/AS/flight/squadron) plus event columns with dropdown codes: P, E, ES, ER, ED, T, U, UR, MU, MRS, N/A, or blank (pending). Credit: P/E/ES/MU/MRS; No credit: U/T/UR/ED; Pending: ER; Excluded: N/A. Include LLAB attendance % and overall attendance % columns.
